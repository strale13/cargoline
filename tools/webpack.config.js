    ...
    return {
        ...
        plugins: [
            ...
            new CopyWebpackPlugin([
                ...
                {from: path.resolve(SRCPATH, 'images/icons'), to: path.resolve(DESTPATH, 'icons')},
                {from: path.resolve(SRCPATH, 'images/favicons'), to: path.resolve(DESTPATH, 'favicons')},
                {from: path.resolve(SRCPATH, 'files'), to: path.resolve(DESTPATH, 'files')}
            ]),
            ...(production ? [
